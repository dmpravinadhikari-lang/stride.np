...
The mark is three squares rotated onto a rising diagonal, sized 1 : φ : φ²,
read as footsteps: pink is the enquiry, orange is the preparation, yellow is
the departure. Ink Navy `#15133A` and Paper `#FAFAFC` do the work of the page;
...
```bash
cd "/Users/pa/Desktop/Education Consultancy" && npm run dev
```
